 ...
 var DeviceInterface = !isDDGApp ? ExtensionInterface : isAndroid ? AndroidInterface : iOSInterface;
 ...
 var isDDGApp = /(iPhone|iPad|Android).*DuckDuckGo\/[0-9]/i.test(window.navigator.userAgent);

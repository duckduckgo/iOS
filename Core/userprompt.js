...
<style>
    ...
    .header-text .header-arrow::after {
        content: " ";
        position: absolute;
        top: 50%;
        right: 100%;
        ...
        border-width: 10px;
        border-style: solid;
        border-color: transparent rgba(66, 66, 66, 0.1) transparent transparent;
    }
...
<div class='form'>
    <div class='header'>
        ...
        <p class='header-text'><span class='header-arrow'></span>This site requested your location. Would you like to share it?</p>
    </div>

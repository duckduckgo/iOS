...
final class ATBAndVariantConfiguration {
    ...
    func configure(onVariantAssigned: () -> Void) {
        cleanUpATBAndAssignVariant(variantManager: variantManager, onVariantAssigned: onVariantAssigned)
    }

    private func cleanUpATBAndAssignVariant(variantManager: VariantManager, onVariantAssigned: () -> Void) {

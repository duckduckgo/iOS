...
class AutofillSettingsEnableFooterView: UIView {
    ...
    private lazy var title: UITextView = {
        ...
        let attributedTextDescription = (try? NSMutableAttributedString(markdown: UserText.autofillLoginListSettingsFooterMarkdown)) ?? NSMutableAttributedString(string: UserText.autofillEmptyViewSubtitle)

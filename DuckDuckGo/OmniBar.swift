...
class OmniBar: UIView {
    ...
    /// Ideally we'd have different constraints for all states that we could turn on/off instead of changing constants
    /// But this will work as a temporary solution until the upcoming UI refactor

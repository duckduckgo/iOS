...
""", comment: "about page")
    ...
    public static let subscriptionUseOnOtherDevices = NSLocalizedString("subscription.add.device.header.title", value: "Use your subscription on all your devices", comment: "Add subscription to other device title ")

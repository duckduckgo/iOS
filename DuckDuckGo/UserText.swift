...
public struct UserText {
    ...
    public static let actionTabClearAll = NSLocalizedString("action.title.tabClearAll", comment: "Clear All Tabs action")
    public static let actionTabClose = NSLocalizedString("action.title.tabClose", comment: "Close Tab action")

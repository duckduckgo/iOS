...
""", comment: "about page")
    ...
    public static let settingsPProITRTitle = NSLocalizedString("settings.ppro.ITR.title", value: "Identity Theft Restioration", comment: "Identity theft restoration cell title for privacy pro")

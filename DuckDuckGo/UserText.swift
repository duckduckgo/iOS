...
""", comment: "about page")
    ...
    public static let subscriptionActivateOnOtherDevices = NSLocalizedString("subscription.activate.on.other.devices", value: "Activate on Other Devices", comment: "Header for section for activating subscription on other devices")
    public static let subscriptionActivateOnOtherDevicesFooter = NSLocalizedString("subscription.activate.on.other.devices.footer", value: "Add an optional email to your subscription or use your Apple ID to access Privacy Pro on other devices. **[Learn more](https://duckduckgo.com/duckduckgo-help-pages/privacy-pro/adding-email/)**", comment: "Footer for section for activating subscription on other devices")

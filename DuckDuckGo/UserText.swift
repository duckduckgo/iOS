...
public struct UserText {
    ...
    static let netPSecureDNSSettingFooter = NSLocalizedString("network.protection.vpn.secure.dns.setting.footer", value: "By default our VPN uses Secure DNS to keep your online activity private, so that your Internet provider can't see what websites you visit.", comment: "Footer text for the Always on VPN setting item.")
    ...
    public static var vpnSettingDNSSectionDisclaimer = NSLocalizedString("vpn.settings.dns.section-disclaimer", value: "When using custom DNS, your queries are not encrypted through our servers. Security and privacy cannot be guaranteed. Use custom DNS carefully.", comment: "Disclaimer for the DNS Server section on the DNS Server screen")

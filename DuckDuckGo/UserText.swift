...
""", comment: "about page")
    ...
    public static let duckPlayerPresentationModalTitle = NSLocalizedString("duckplayer.presentation.modal.title", value: "Drowning in ads on YouTube?\nTry Duck Player!", comment: "Two line title (separated by \n) for the feature explanation")

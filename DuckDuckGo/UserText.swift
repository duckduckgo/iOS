...
public struct UserText {
    ...
    public static let messageProtectionDisabledAndToggleReportSent = NSLocalizedString("toast.protection.disabled.and.toggle.report.sent", value: "Privacy Protection disabled for %@ and report sent.", comment: "Confirmation of an action - populated with a domain name")

...
public struct UserText {
    ...
    public static let actionForgetTabHeader = NSLocalizedString("action.title.forgetTabHeader", value: "Adjust the slider to clear data for the listed website", comment: "")

...
public struct UserText {
    ...
    public static let loginPlusSavePasswordTitle = NSLocalizedString("loginplus.save-password.title", value: "Save Password?", comment: "Title displayed on modal asking for the user to save the password")
    public static let loginPlusUpdatePasswordTitle = NSLocalizedString("loginplus.update-password.title", value: "Update Password?", comment: "Title displayed on modal asking for the user to update the password")

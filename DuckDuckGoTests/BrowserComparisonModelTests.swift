...
final class BrowserComparisonModelTests: XCTestCase {
    ...
    func testBrowserComparisonFeatureBlockThirdPartyTrackersIsCorrect() throws {
        ...
        // THEN
        XCTAssertEqual(result, UserText.OnboardingHighlights.BrowsersComparison.Features.trackerBlockers)
    }
    ...
    func testBrowserComparisonFeatureBlockCookiePopupsIsCorrect() throws {
        ...
        // THEN
        XCTAssertEqual(result, UserText.OnboardingHighlights.BrowsersComparison.Features.cookiePopups)
    }
    ...
    func testBrowserComparisonFeatureBlockCreepyAdsIsCorrect() throws {
        ...
        // THEN
        XCTAssertEqual(result, UserText.OnboardingHighlights.BrowsersComparison.Features.creepyAds)
    }
    ...
    func testWhenIsNotHighlightsThenBrowserComparisonFeatureEraseBrowsingDataIsCorrect() throws {
        ...
        // THEN
        XCTAssertEqual(result, UserText.OnboardingHighlights.BrowsersComparison.Features.eraseBrowsingData)
    }

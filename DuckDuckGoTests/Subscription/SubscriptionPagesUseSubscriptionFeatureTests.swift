...
final class SubscriptionPagesUseSubscriptionFeatureTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        feature = SubscriptionPagesUseSubscriptionFeature(subscriptionManager: SubscriptionManagerMock(),
...
//        let result = await feature.getSubscription(params: <#T##Any#>, original: <#T##WKScriptMessage#>)
    }
}

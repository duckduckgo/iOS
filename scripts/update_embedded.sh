...
performUpdate 'https://staticcdn.duckduckgo.com/trackerblocking/v6/current/ios-tds.json' "${base_dir}/Core/AppTrackerDataSetProvider.swift" "${base_dir}/Core/trackerData.json"
